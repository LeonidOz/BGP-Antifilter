...
- `BGP_ANTIFILTER_VERSION` - тег локального Docker-образа, по умолчанию `0.3.1`.
- `MT_AS` - AS MikroTik.
...
- `Списки` - редактирование `lists.txt`, `include-asns.txt`, `include-domains.txt`, `exclude-domains.txt` без конфликтов с `git pull`.
